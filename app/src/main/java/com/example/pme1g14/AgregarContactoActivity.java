...
import com.example.PME1G14.conexion.SQLiteConexion;
import com.example.PME1G14.transacciones.Contactos;
...
public class AgregarContactoActivity extends AppCompatActivity {
        ...
        if (fotoIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (archivo != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.example.PME1G14.fileprovider",
                        archivo);
    ...
    public void abrirFolder(){
        ...
        Uri uri = Uri.parse("/storage/emulated/0/Android/data/com.example.PME1G14/files/Pictures/");
